...
um ano, uma volta completa, uma história que gira em torno de nós dois. 🌎☀️
---

## 🗒️ Instruções:

1. Antes de interagir com o projeto, pressione **`Shift + F5`** para recarregar as páginas corretamente;  
2. Rode o arquivo **Python** no terminal que está na raiz do projeto para uma surpresinha.  

---

✨ *Com amor, do seu dev favorito.*
